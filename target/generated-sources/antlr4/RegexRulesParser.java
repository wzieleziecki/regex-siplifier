...
public class RegexRulesParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "WHITESPACE", "NEWLINE", "LETTER", "'['", "']'", "'('", "')'", 
		"'*'", "'@'", "'.'", "'-'", "'^'", "'$'", "'{'", "'}'", "','", "NUMBER", 
		"LAST_TOKEN", "'+'", "'?'", "'|'"
	};
	public static final int
		...
		try {
			...
			case 1:
				...
				do {
					...
					do {
						...
						case 1:
							{
							setState(16); basicExpression();
							}
							break;
						case 2:
							{
							setState(17); alternativeExpression(0);
							}
							break;
						case 3:
							{
							setState(18); parentheseExpression();
							}
							break;
						case 4:
							{
							setState(19); bracketExpression();
							}
							break;
						case 5:
							{
							setState(20); matchCountExpression();
							}
							break;
						}
						}
			...
			case 2:
				...
				do {
					{
					{
					setState(31); alternativeExpression(0);
	...
	public final ParentheseExpressionContext parentheseExpression() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(40); match(LEFT_PARENTHESE);
				setState(45); 
				_errHandler.sync(this);
				_la = _input.LA(1);
				do {
					...
					case 1:
						{
						setState(41); parentheseExpression();
						}
						break;
					case 2:
						{
						setState(42); bracketExpression();
						}
						break;
					case 3:
						{
						setState(43); matchCountExpression();
						}
						break;
					case 4:
						{
						setState(44); basicExpression();
						}
						break;
					}
					}
				...
				setState(49); match(RIGHT_PARENTHESE);
				setState(51);
				switch ( getInterpreter().adaptivePredict(_input,7,_ctx) ) {
				case 1:
					{
					setState(50); match(LAST_TOKEN);
					}
					break;
				}
				}
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(53); match(LEFT_PARENTHESE);
				{
				setState(54); alternativeExpression(0);
				}
				setState(55); match(RIGHT_PARENTHESE);
				setState(57);
				switch ( getInterpreter().adaptivePredict(_input,8,_ctx) ) {
				case 1:
					{
					setState(56); match(LAST_TOKEN);
					}
					break;
				}
				}
	...
	private AlternativeExpressionContext alternativeExpression(int _p) throws RecognitionException {
		...
		try {
			...
			do {
				...
				case 1:
					{
					setState(62); parentheseExpression();
					}
					break;
				case 2:
					{
					setState(63); basicExpression();
					}
					break;
				case 3:
					{
					setState(64); matchCountExpression();
					}
					break;
				case 4:
					{
					setState(65); bracketExpression();
					}
					break;
				}
				}
			...
			do {
				...
				case 1:
					...
					case 1:
						{
						setState(71); parentheseExpression();
						}
						break;
					case 2:
						{
						setState(72); basicExpression();
						}
						break;
					case 3:
						{
						setState(73); matchCountExpression();
						}
						break;
					case 4:
						{
						setState(74); bracketExpression();
						}
						break;
					}
					}
				...
				if ( _alt==1 ) {
					...
					do {
						...
						case 1:
							...
							case 1:
								{
								setState(81); parentheseExpression();
								}
								break;
							case 2:
								{
								setState(82); basicExpression();
								}
								break;
							case 3:
								{
								setState(83); matchCountExpression();
								}
								break;
							case 4:
								{
								setState(84); bracketExpression();
								}
								break;
							}
							}
	...
	public final MatchCountExpressionContext matchCountExpression() throws RecognitionException {
		...
		try {
			...
			case DOT:
				enterOuterAlt(_localctx, 1);
				{
				setState(94); basicExpression();
				setState(95); rangeOccurence();
				}
				break;
			case LEFT_BRACKET:
				enterOuterAlt(_localctx, 2);
				{
				setState(97); bracketExpression();
				setState(98); rangeOccurence();
				}
				break;
			case LEFT_PARENTHESE:
				enterOuterAlt(_localctx, 3);
				{
				setState(100); parentheseExpression();
				setState(101); rangeOccurence();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final BracketExpressionContext bracketExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(116); match(LEFT_BRACKET);
			setState(118);
			_la = _input.LA(1);
			if (_la==CARET) {
				{
				setState(117); match(CARET);
				}
			}
			...
			do {
				...
				case 2:
					{
					setState(121); matchCountExpression();
					}
					break;
				case 3:
					{
					setState(122); basicExpression();
					}
					break;
				case 4:
					{
					setState(123); parentheseExpression();
					}
					break;
				case 5:
					{
					setState(124); bracketExpression();
					}
					break;
				case 6:
					{
					setState(125); alternativeExpression(0);
					}
					break;
				}
				}
	...
	public final RangeContext range() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState